...
function showUserRole(){
	var list=$("#userinfo4org-mainGrid");
	var row = list.datagrid("getSelected");
	var roleList=$("#userinfo4org-roleGrid");
	var roleDialog=$("#userinfo4org-role-gridDialog");
	var roleToolbar=$("#userinfo4org-roleGridToolbar");
	var allRoleList=$("#userinfo4org-allRoleGrid");
	var allRoleDialog=$("#userinfo4org-allRole-gridDialog");
	var allRoleToolbar=$("#userinfo4org-allRoleToolbar");
	var listType = "loan";
	if(row==null){
	...
	UI.bindEvents({
		"add-role-button":function(){
			allRoleList.datagrid({
				...
				rownumbers:true,
				pagination:true,
				toolbar:"#userinfo4org-allRoleToolbar",
				columns:[[
				          {field:"ck",checkbox:true},
				          {field:"roleName",title:"角色名称",width:100},
				          {field:"roleDescription",title:"角色说明",width:200},
