package com.hexin.core.util.logging;
...
public class LogFactory {
    ...
    static {
        ...
        tryImplementation("org.apache.log4j.Logger", "com.hexin.core.util.logging.Log4jImpl");
        tryImplementation("org.slf4j.Logger", "com.hexin.core.util.logging.SLF4JImpl");
        tryImplementation("org.apache.commons.logging.LogFactory",
                          "com.hexin.core.util.logging.JakartaCommonsLoggingImpl");
        tryImplementation("java.util.logging.Logger", "com.hexin.core.util.logging.Jdk14LoggingImpl");
    ...
    public static synchronized void selectLog4JLogging() {
        try {
            ...
            Class implClass = Resources.classForName("com.hexin.core.util.logging.Log4jImpl");
            logConstructor = implClass.getConstructor(new Class[] { String.class });
        } catch (Throwable t) {
            //ignore
        }
    ...
    public static synchronized void selectJavaLogging() {
        try {
            ...
            Class implClass = Resources.classForName("com.hexin.core.util.logging.Jdk14LoggingImpl");
            logConstructor = implClass.getConstructor(new Class[] { String.class });
        } catch (Throwable t) {
            //ignore
        }
